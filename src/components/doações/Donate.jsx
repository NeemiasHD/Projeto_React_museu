...
function Donate() {
  ...
  return (
    <div className="donateContainer">
      ...
      <p className="DoeText" style={ModoEscuro?{color:"var(--corFundoBranco)",backgroundColor:"var(--CorCinza)"}:{color:"var(--corFundoPreto)"}}>
      <img src="src/img/logomuseu.png" width={"250px"} />
        Você pode fazer a diferença na preservação da história da computação! O
        Museu da Computação é um tesouro de inovação e conhecimento, mas precisa
        de sua ajuda para continuar inspirando as gerações futuras. Por favor,
        considere fazer uma doação hoje para garantir que esse legado vital seja
        preservado. Clique no botão abaixo para fazer sua doação agora❤️❤️
